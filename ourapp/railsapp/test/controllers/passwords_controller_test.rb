...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference("Password.count") do
      post passwords_url, params: { password: { hashed_password: @password.hashed_password, test_user_id: @password.test_user_id } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { hashed_password: @password.hashed_password, test_user_id: @password.test_user_id } }
